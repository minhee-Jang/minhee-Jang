...
class VSRBasic(BaseModel):
    ...
    def forward(self):
        self.out = self.net(self.x).transpose(1, 2)
...
from models.mmedit.models.common.sr_backbone_utils import ResidualBlockNoBN, make_layer
from models.mmedit.models.common.flow_warp import flow_warp
from models.mmedit.utils.logger import get_root_logger
