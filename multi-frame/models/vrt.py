...
running 
python .\train.py --model vrt --dataA ldv3 --n_frames 16 --patch_size 256 --batch_size 2
"""
...
class VRTModel(nn.Module):
    ...
    def __init__(self,
        ...
        self.in_chans = opt.n_channels
        in_chans = opt.n_channels
        self.upscale = opt.scale
        upscale = opt.scale
        img_size = [opt.n_frames, opt.patch_size, opt.patch_size]
