...
class LDV3(SRData):
    ...
    def _set_filesystem(self, data_dir):
        self.apath = os.path.join(data_dir, 'ldv2022', 'track3')
        # self.apath = os.path.join(data_dir, 'ldv2022', 'track3_test')

        if self.is_train:
            self.dir_hr = os.path.join(self.apath, 'train_down4_gt')
            self.dir_lr = os.path.join(self.apath, 'train_down4_QP37')
        else:
            self.dir_hr = os.path.join(self.apath, 'validation_track3')
            self.dir_lr = os.path.join(self.apath, 'validation_track3')
