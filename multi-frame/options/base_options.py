...
class BaseOptions():
    ...
    def __init__(self, dataroot='../../data/multi-frame-image-enhancement'):
        ...
        self.testresult_dir = os.path.join(self.dataroot, 'test-results-frame')
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--move_thr', type=int, default=120,
            help='threshold for moving map, Default: 120')
