...
class VimeoQP1(SRData):
    ...
    def _scan(self):
        ...
        for vid in video_list:
            ...
            # lrf = glob.glob(lrp)
            # hrf = glob.glob(hrp)
            # assert len(lrf) == 7, f'lrp:  {lrp}'
            # assert len(hrf) == 7, f'hrp:  {hrp}'
            # print('lr: ', lrp)
            # print('hr: ', hrp)
    ...
    def _set_filesystem(self, data_dir):
        ...
        self.dir_lr = os.path.join(self.apath, 'sequences_qp37')
