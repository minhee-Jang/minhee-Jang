...
class BaseModel(ABC):
    ...
    def set_savedir(self):
        ...
        1. customize opt parameters
        2. set save directory to save checkpoints
        """
        pass
        ...
        if self.multi_gpu:
            for net_name in self.model_names:
                if isinstance(net_name, str):
                    ...
                    # print("{} multi_gpu".format(net_name))
    ...
    def load_networks(self, epoch):
        ...
        # load_path = os.path.join(pth_dir, epoch_path)
        # print("load_path:", epoch_path)
        ...
        print('finished loading the checkpoint from {} with epoch {} and psnr {:.8f}'.format(
            os.path.abspath(epoch_path), epoch, psnr))
        return epoch, psnr
